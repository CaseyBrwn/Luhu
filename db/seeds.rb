...
show1.tall_photo.attach(io: file11, filename: 'wave_tall.jpg')
file12 = open("https://luhu-seeds.s3.amazonaws.com/nature_square.jpg")
show1.square_photo.attach(io: file12, filename: 'nature_square.jpg')
...
file2 = open("https://luhu-seeds.s3.amazonaws.com/cat_tall.png")
...
episode12.photo.attach(io: file38, filename: 'cat_hissing.jpg')
file39 = open("https://luhu-seeds.s3.amazonaws.com/cat_hissing.webm")
episode12.video.attach(io: file39, filename: 'cat_hissing.webm')
